...
Python_LTI_MPC_Tester::Python_LTI_MPC_Tester() {
...
void Python_LTI_MPC_Tester::test_mpc(void) {
  ...
  unsigned long time_start[Python_LTI_MPC_Tester::SIM_STEP_MAX] = {0};
  unsigned long time_end[Python_LTI_MPC_Tester::SIM_STEP_MAX] = {0};

  std::array<PythonControl::StateSpaceOutput_Type<
                 float, Python_LTI_MPC_Tester::OUTPUT_SIZE>,
             Python_LTI_MPC_Tester::SIM_STEP_MAX>
      y_array;
  std::array<PythonControl::StateSpaceInput_Type<
                 float, Python_LTI_MPC_Tester::INPUT_SIZE>,
             Python_LTI_MPC_Tester::SIM_STEP_MAX>
      u_array;

  for (std::size_t sim_step = 0; sim_step < Python_LTI_MPC_Tester::SIM_STEP_MAX;
       ++sim_step) {
    /* system response */
    sys.update(U);
