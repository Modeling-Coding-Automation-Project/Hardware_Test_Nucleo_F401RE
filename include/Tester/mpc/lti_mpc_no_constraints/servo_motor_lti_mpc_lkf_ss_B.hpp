#ifndef __SERVO_MOTOR_LTI_MPC_LKF_SS_B_HPP__
#define __SERVO_MOTOR_LTI_MPC_LKF_SS_B_HPP__

#include "python_numpy.hpp"

namespace servo_motor_lti_mpc_lkf_ss_B {
...
#endif // __SERVO_MOTOR_LTI_MPC_LKF_SS_B_HPP__
