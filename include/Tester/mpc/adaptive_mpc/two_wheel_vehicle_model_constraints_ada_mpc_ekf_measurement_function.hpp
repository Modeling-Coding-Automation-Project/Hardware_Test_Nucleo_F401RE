#ifndef __TWO_WHEEL_VEHICLE_MODEL_CONSTRAINTS_ADA_MPC_EKF_MEASUREMENT_FUNCTION_HPP__
#define __TWO_WHEEL_VEHICLE_MODEL_CONSTRAINTS_ADA_MPC_EKF_MEASUREMENT_FUNCTION_HPP__
...
namespace two_wheel_vehicle_model_constraints_ada_mpc_ekf_measurement_function {
...
inline auto sympy_function(const float px, const float theta, const float V,
                           const float py, const float r) -> Y_Type {
...
inline auto function(const X_Type X, const Parameter_Type Parameters)
  ...
  return sympy_function(px, theta, V, py, r);
}

} // namespace
  // two_wheel_vehicle_model_constraints_ada_mpc_ekf_measurement_function

#endif // __TWO_WHEEL_VEHICLE_MODEL_CONSTRAINTS_ADA_MPC_EKF_MEASUREMENT_FUNCTION_HPP__
