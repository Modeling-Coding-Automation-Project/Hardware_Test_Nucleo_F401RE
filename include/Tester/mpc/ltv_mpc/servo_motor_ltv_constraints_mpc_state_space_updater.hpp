#ifndef SERVO_MOTOR_LTV_CONSTRAINTS_MPC_STATE_SPACE_UPDATER_HPP_
#define SERVO_MOTOR_LTV_CONSTRAINTS_MPC_STATE_SPACE_UPDATER_HPP_
...
#endif // SERVO_MOTOR_LTV_CONSTRAINTS_MPC_STATE_SPACE_UPDATER_HPP_
