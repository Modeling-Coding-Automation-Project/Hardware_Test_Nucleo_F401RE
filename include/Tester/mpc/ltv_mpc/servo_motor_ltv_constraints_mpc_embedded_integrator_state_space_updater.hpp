...
static inline auto update(double Lshaft, double dshaft, double shaftrho, double G, double Mmotor, double Rmotor, double Bmotor, double R, double Kt, double Bload) -> A_Updater_Output_Type {
        ...
        return A_Updater::sympy_function(Rmotor, Lshaft, Bmotor, dshaft, R, shaftrho, G,
    Mmotor, Bload, Kt);
}

static inline auto sympy_function(double Rmotor, double Lshaft, double Bmotor, double dshaft, double R, double shaftrho, double G, double Mmotor, double Bload, double Kt) -> A_Updater_Output_Type {
