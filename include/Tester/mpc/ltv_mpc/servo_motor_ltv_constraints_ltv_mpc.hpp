...
constexpr std::size_t INPUT_SIZE =
    servo_motor_ltv_constraints_ltv_mpc_lkf::INPUT_SIZE;
constexpr std::size_t STATE_SIZE =
    servo_motor_ltv_constraints_ltv_mpc_lkf::STATE_SIZE;
constexpr std::size_t OUTPUT_SIZE =
    servo_motor_ltv_constraints_ltv_mpc_lkf::OUTPUT_SIZE;

constexpr std::size_t AUGMENTED_STATE_SIZE = STATE_SIZE + OUTPUT_SIZE;

constexpr std::size_t NUMBER_OF_DELAY =
    servo_motor_ltv_constraints_ltv_mpc_lkf::NUMBER_OF_DELAY;
...
using SolverFactor_Type =
    servo_motor_ltv_constraints_ltv_mpc_solver_factor::type;
...
using type =
    LTV_MPC_Type<LKF_Type, PredictionMatrices_Type, ReferenceTrajectory_Type,
                 Parameter_Type, Delta_U_Min_Type, Delta_U_Max_Type, U_Min_Type,
                 U_Max_Type, Y_Min_Type, Y_Max_Type, SolverFactor_Type>;
...
inline auto make() -> type {
  ...
  auto solver_factor =
      servo_motor_ltv_constraints_ltv_mpc_solver_factor::make();
  ...
  LTV_MPC_Phi_F_Updater_Function_Object<EmbeddedIntegratorSateSpace_Type,
      ...
      LTV_MPC_Phi_F_Updater_Function =
          servo_motor_ltv_constraints_ltv_mpc_phi_f_updater::
              LTV_MPC_Phi_F_Updater::update<EmbeddedIntegratorSateSpace_Type,
                                            Parameter_Type, Phi_Type, F_Type>;
