#ifndef SERVO_MOTOR_LTV_CONSTRAINTS_DELTA_U_MAX_HPP_
#define SERVO_MOTOR_LTV_CONSTRAINTS_DELTA_U_MAX_HPP_
...
#endif // SERVO_MOTOR_LTV_CONSTRAINTS_DELTA_U_MAX_HPP_
